...
__CHANNEL_USERNAME__ = "Lê Quyền Ngự"
__GROUP_USERNAME__   = "Zalo : 0879951092"
...
def banner(console):
    ...
    console.print("[bold green]♕ Lê Quyền Ngự[/bold green]: Car Parking Multiplayer Hacking Tool.")
